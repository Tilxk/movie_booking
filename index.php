    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./_index.html">About</a></li>
                    </ul>
                </div>
            </div>
        </nav>
       ...
       ?>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - Movie Theater Seat Reservation System</div></div>
        </footer>
        <!-- Bootstrap core JS-->
